...
export const PROGRAMS_YUE: Record<string, ProgramYue> = {
  foundation: {
    ...
    description:
      "三堂全身訓練，由淺入深。你會學識點推、點蹲、點拉，仲有髖鉸鏈同核心控制。喺屋企就練到，唔一定要去健身室。",
    equipment: "徒手（唔使器材）",
    level: "初階",
    sessions: {
      "foundation-a": {
  ...
  "barbell-base": {
    ...
    tagline: "臥推、深蹲、硬舉、划船",
    description:
      "經典力量四式：臥推、深蹲、硬舉、划船。建議你已經穩陣掌握徒手同啞鈴先開始。動作質素一定要放喺重量前面。",
    equipment: "槓鈴同深蹲架",
    level: "高階",
    sessions: {
      "bb-a": {
        ...
        focus: "下半身力量",
        coaching: {
          "0043": "出架之前先收腹。活動度夠嘅話，蹲到髖摺位低過膝頭。",
          "0085": "羅馬尼亞鉸鏈——槓貼身，膕繩肌受力，背唔好圓。",
          "1370": "大重量之後，可以加做小腿。",
        },
        notes: {
          "0043:0": "工作組——留一兩下儲備",
