  ...
  foundation: {
    ...
    sessions: {
      "foundation-a": {
        ...
        focus: "推嘅模式 + 軀幹穩定",
        coaching: {
          "0493": "脊骨保持長。控制落去。每一下都想像推開地面。",
          "3013": "肋骨向下，頂部用力夾尻——唔好淨係用腰。",
          "0274": "捲起時呼氣。唔好扯頸——下巴輕輕收。",
      ...
      "foundation-b": {
        ...
        focus: "深蹲、弓步、水平拉",
        coaching: {
          "1685": "髖向後向下坐。膝跟住腳中線。企直。",
          "1460": "步幅長，前膝軟，軀幹挺。兩邊平均換。",
          "0499": "胸口拉向槓／線。夾肩胛。每下之間完全吊直。",
          "0276": "腰貼實。只郁手同對側腳——要慢。",
          "0630": "手喺膊下，髖低，腳輕——質素大過速度。",
        },
        notes: {},
      },
      "foundation-c": {
        ...
        focus: "心肺 + 技巧打磨",
        coaching: {
          "0662": "由斜板進步到平地。手肘同身體約 45 度。",
          "0514": "落地要輕，深蹲做夠深。膝唔舒服就唔好跳。",
          "0651": "由死吊開始。手肘向下拉。下巴過槓。",
          "3544": "髖疊喺腳踭上。頂髖向上，唔好扭身。",
          "1160": "落地要順。需要可以踏後代替跳。",
        },
        notes: {
          "0651:0": "或者用輔助／彈力帶",
  ...
  "dumbbell-engine": {
    ...
    sessions: {
      "db-push": {
        ...
        focus: "胸 · 膊 · 三頭",
        coaching: {
          "0289": "手腕疊喺手肘上。輕觸胸口，平均推起。",
          "0405": "收腹。肋骨唔好打開。路徑略向前過面。",
          "0334": "手肘帶動，輕微彎，到膊高度停。",
          "0285": "手肘固定。唔好甩。落重用 2–3 秒。",
        },
        notes: {},
      },
      "db-pull": {
        ...
        focus: "背 · 後三角 · 二頭",
        coaching: {
          "0293": "髖鉸鏈，背平。手肘拉向髖，唔好拉向耳。",
          "0327": "胸口貼櫈，頂部夾實，控制伸展。",
          "0311": "拇指微向上。唔好聳膊。頂部幅度要完整。",
          "0285": "以嚴格彎舉收尾——唔好借髖力。",
        },
        notes: {},
      },
      "db-legs": {
        ...
        focus: "股四頭 · 尻 · 後鏈",
        coaching: {
          "1760": "啞鈴捧喺胸口。底部手肘喺膝入面。",
          "1459": "膝軟，髖向後推，感覺腘繩肌。夾尻企起。",
          "1460": "可以手提啞鈴。膝跟住腳尖線。",
          "3013": "橋式收尾——每一下都夾實尻。",
        },
        notes: {},
  ...
  "barbell-base": {
    ...
    sessions: {
      "bb-a": {
        ...
        focus: "下半身力量",
        coaching: {
          "0043": "出架前先收腹。活動度夠就蹲到髖皺低過膝。",
          "0085": "羅馬尼亞鉸鏈——槓貼身，腘繩肌受力，背唔好圓。",
          "1370": "大重量之後可選做小腿。",
        },
        notes: {
          "0043:0": "工作組——留 1–2 下儲備",
        },
      },
      "bb-b": {
        title: "日 B · 推舉重點",
