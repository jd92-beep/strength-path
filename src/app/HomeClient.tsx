        ...
        <Reveal delay={80}>
          <section className="hero-chips" aria-label={tr("summary")}>
            <Link href="/path" className="hero-chip" style={{ ["--c" as string]: "var(--ring-move)" }}>
              <strong><AnimatedNumber value={progress.completedSessions.length} /></strong> {tr("sessions")}
            </Link>
            <Link href="/history" className="hero-chip" style={{ ["--c" as string]: "var(--ring-exercise)" }}>
              <strong><AnimatedNumber value={stats.totalSets} /></strong> {tr("loggedSets").toLowerCase()}
            </Link>
            <Link href="/history" className="hero-chip" style={{ ["--c" as string]: "var(--ring-stand)" }}>
              <strong><AnimatedNumber value={stats.daysActive} /></strong> {tr("daysActive").toLowerCase()}
            </Link>
          </section>
        </Reveal>
